...
# @pytest.fixture
# def token(client):
#     client.post("/auth/register", json={"username": "itemuser", "password": "pass"})
#     res = client.post("/auth/login", json={"username": "itemuser", "password": "pass"})
...
#     assert res.json()["name"] == "Sample Item"
#
...
#     )
#     assert res.status_code == 200
#     assert res.json()["name"] == "Updated Item"
#
