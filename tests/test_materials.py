...
#     client.post("/auth/register", json={"username": "matuser", "password": "matpass"})
#     res = client.post("/auth/login", json={"username": "matuser", "password": "matpass"})
#     return res.json()["access_token"]
#
# def test_create_material(client, auth_token):
#     res = client.post(
#         "/materials/",
#         headers={"Authorization": f"Bearer {auth_token}"},
#         json={"name": "Steel", "density": 7.8, "color": "Gray"},
#     )
#     assert res.status_code in [200, 201]
#     assert res.json()["name"] == "Steel"
#
# def test_update_material(client, auth_token):
#     res = client.post(
#         "/materials/",
#         headers={"Authorization": f"Bearer {auth_token}"},
#         json={"name": "Wood", "density": 0.8, "color": "Brown"},
#     )
...
#         headers={"Authorization": f"Bearer {auth_token}"},
#         json={"name": "Oak Wood", "density": 0.9, "color": "Dark Brown"},
#     )
#     assert res.status_code == 200
#     assert res.json()["name"] == "Oak Wood"
#
# def test_delete_material(client, auth_token):
#     res = client.post(
#         "/materials/",
#         headers={"Authorization": f"Bearer {auth_token}"},
#         json={"name": "Plastic", "density": 1.1, "color": "White"},
#     )
#     material_id = res.json()["id"]
#
#     res = client.delete(
...
#
#     res = client.get(f"/materials/{material_id}")
